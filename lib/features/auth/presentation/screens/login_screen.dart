              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Auto30', style: TextStyle(fontSize: 36, fontWeight: FontWeight.bold, color: Colors.orange)),
                    const SizedBox(height: 8),
                    Text('自主學習促進會', style: TextStyle(fontSize: 20, color: Colors.red, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 8),
                    Text('開始你的自主學習互助之旅', style: TextStyle(fontSize: 16, color: Colors.black38)),
                  ],
                ),
              ),
              // 登入表單
              Container(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('登入帳號', style: TextStyle(fontSize: 22, color: Colors.orange, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                      const SizedBox(height: 16),
                      TextFormField(
                      ...
                      Align(
                        ...
                        child: TextButton(
                          ...
                          child: Text('忘記密碼?', style: TextStyle(color: Colors.orange)),
                        ),
                      ),
                      const SizedBox(height: 8),
                      ElevatedButton(
                        ...
                        child: authProvider.isLoading ? const CircularProgressIndicator() : const Text('登入', style: TextStyle(fontSize: 18)),
                      ),
                      const SizedBox(height: 12),
                      Row(
                        children: const [
                          ...
                          Padding(
                            ...
                            child: Text('或', style: TextStyle(color: Colors.black38)),
                          ),
                          Expanded(child: Divider()),
                        ],
                      ),
                      ...
                      const SizedBox(height: 16),
                      OutlinedButton.icon(
                        onPressed: authProvider.isLoading ? null : () => authProvider.signInAnonymously(),
                        icon: Icon(Icons.person, color: Colors.orange),
                        label: Text('以訪客身分進入', style: TextStyle(color: Colors.orange)),
